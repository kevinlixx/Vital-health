            ...
            <div class="row--right">
                <div class="col-md-6">
                    <div class="text">
                        ...
                        <p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 24 24">
                                <path fill="currentColor" d="M7.774 5.215L6.326 3.767A9.995 9.995 0 0 1 20.23 17.67l-1.445-1.445a7.99 7.99 0 0 0-11.01-11.01Zm12.588 15.149l-1.279 1.279l-1.413-1.414A9.995 9.995 0 0 1 3.768 6.327l-1.41-1.41l1.278-1.28l1.29 1.292l1.417 1.413L11 11.002V7h1.5v5.25l4.5 2.67l-.75 1.23l-.254-.152Zm-4.136-1.58l-5.793-5.792l-5.218-5.218a7.99 7.99 0 0 0 11.01 11.01Z" />
                            </svg>
                        ...
                        <p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 20 20">
                                <g fill="currentColor">
                                    <path fill-rule="evenodd" d="M13.322 7.384A4.501 4.501 0 0 1 16 11.5V14a2 2 0 0 1-2 2h-.585c.055.156.085.325.085.5v2A1.5 1.5 0 0 1 12 20h-1a1.5 1.5 0 0 1-1.5-1.5v-2c0-.175.03-.344.085-.5H9a2 2 0 0 1-2-2v-2.5a4.5 4.5 0 0 1 2.678-4.116a3 3 0 1 1 3.643 0Z" clip-rule="evenodd" opacity=".2" />
                                    <path d="M12.75 12a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm-3.5 0a1 1 0 1 1-2 0a1 1 0 0 1 2 0Z" />
                                    <path fill-rule="evenodd" d="M10 7a3 3 0 1 0 0-6a3 3 0 0 0 0 6Zm0-5a2 2 0 1 1 0 4a2 2 0 0 1 0-4Zm.5 12h-1A1.5 1.5 0 0 0 8 15.5v2A1.5 1.5 0 0 0 9.5 19h1a1.5 1.5 0 0 0 1.5-1.5v-2a1.5 1.5 0 0 0-1.5-1.5ZM9 15.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-2Z" clip-rule="evenodd" />
                                    <path d="M15.5 3.75a.75.75 0 0 1 0-1.5h2a.75.75 0 0 1 0 1.5h-2Zm-13 0a.75.75 0 0 1 0-1.5h2a.75.75 0 0 1 0 1.5h-2Z" />
                                    <path d="m4.106 3.364l.302-.97l3.698.742l-.302.97l-3.698-.742Zm7.788-.228l.302.97l3.698-.742l-.302-.97l-3.698.742Z" />
                                    <path fill-rule="evenodd" d="M14.5 10.5a4.5 4.5 0 1 0-9 0V13a2 2 0 0 0 2 2h5a2 2 0 0 0 2-2v-2.5Zm-8 0a3.5 3.5 0 1 1 7 0V13a1 1 0 0 1-1 1h-5a1 1 0 0 1-1-1v-2.5Z" clip-rule="evenodd" />
                        ...
                        <p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 48 48">
                                <g fill="currentColor">
                                    <path fill-rule="evenodd" d="M41.708 23.794L24.058 6.086L6.294 23.792a1 1 0 1 0 1.412 1.416L10 22.922V41a1 1 0 0 0 1 1h26a1 1 0 0 0 1-1V22.907l2.292 2.3a1 1 0 1 0 1.416-1.413ZM24.053 8.914L36 20.9V40H12V20.928L24.053 8.914Z" clip-rule="evenodd" />
                                    <path d="M16 25.517C16 22.655 17.794 20 20.25 20c1.704 0 2.97 1.191 3.75 2.88c.78-1.689 2.045-2.88 3.75-2.88c2.456 0 4.25 2.655 4.25 5.517C32 31.645 24 36 24 36s-5.389-2.756-7.32-7.278a8.863 8.863 0 0 1-.36-1a7.851 7.851 0 0 1-.32-2.205Z" />
                                </g>
                            </svg>
            ...
            <div class="row--right">
                <div class="col-md-6">
                    <div class="text">
                        ...
                        <p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 24 24">
                                <path fill="currentColor" d="M19.5 15.5L16 12l3.5-3.5l1.4 1.4l-1.075 1.1H23v2h-3.175l1.075 1.1l-1.4 1.4ZM2 22V2h13v20H2Zm2-11.475q.45-.275.95-.4T6 10h5q.55 0 1.05.125t.95.4V4H4v6.525ZM8.5 9q-.825 0-1.413-.588T6.5 7q0-.825.588-1.413T8.5 5q.825 0 1.413.588T10.5 7q0 .825-.588 1.413T8.5 9Zm-1 10h2v-2h2v-2h-2v-2h-2v2h-2v2h2v2Z" />
                            </svg>
                        ...
                        <p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 48 48">
                                <g fill="currentColor">
                                    ...
                                    <path fill-rule="evenodd" d="M4 16a2 2 0 0 1 2-2h22a2 2 0 0 1 1.732 1H30v4h1v-1h1v-1a1 1 0 1 1 2 0v1h1v1h.718a3 3 0 0 1 2.035.796l5.282 4.875A3 3 0 0 1 44 26.876V35h-5.126a4.002 4.002 0 0 1-7.748 0H15.874a4.002 4.002 0 0 1-7.748 0H4V16Zm38 12H30v5h1.126a4.002 4.002 0 0 1 7.748 0H42v-5Zm-12-2h11.526l-5.13-4.735a1 1 0 0 0-.678-.265H30v5ZM12 36a2 2 0 1 0 0-4a2 2 0 0 0 0 4Zm25-2a2 2 0 1 1-4 0a2 2 0 0 1 4 0ZM13 22h3v-3h2v3h3v2h-3v3h-2v-3h-3v-2Z" clip-rule="evenodd" />
                                    <path d="M36.5 17a1 1 0 0 1 1-1H39a1 1 0 1 1 0 2h-1.5a1 1 0 0 1-1-1Zm-.672-4.241a1 1 0 1 0 1.343 1.482l.915-.828a1 1 0 0 0-1.343-1.482l-.915.828Z" />
                                </g>
                            </svg>
                        ...
                        <p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 24 24">
                                <path fill="currentColor" d="M20 4a2 2 0 0 1 2 2v10c0 1.11-.89 2-2 2h4v2H0v-2h4a2 2 0 0 1-2-2V6c0-1.11.89-2 2-2h16m0 2H4v10h16V6m-8 6c2.21 0 4 .9 4 2v1H8v-1c0-1.1 1.79-2 4-2m0-5a2 2 0 1 1 0 4c-1.11 0-2-.89-2-2s.9-2 2-2Z" />
                            </svg>
